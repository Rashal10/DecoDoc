...
export function EmailAuthForm({ mode, onSuccess, compact }: EmailAuthFormProps) {
  ...
  const subtitle = isSignUp
    ...
    : "Sign in to your DecoDoc account";

  return (
    <div className={compact ? "" : "w-full"}>
      {!compact && (
        <div className="mb-6">
          <h1 className="font-dialogue text-2xl font-semibold text-[var(--color-carbon-ink)]">
            {title}
          </h1>
          <p className="mt-1 text-sm text-[var(--color-fossil-gray)]">{subtitle}</p>
        </div>
      )}
      ...
      <p className="mt-5 text-center text-sm text-[var(--color-fossil-gray)]">
        {isSignUp ? (
          <>
